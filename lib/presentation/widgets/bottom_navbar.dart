  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: const Color(0xff5bb045),
            ...
            GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(
                    ...
                    size: 30,
                    color:
                        indexColor == 0 ? const Color(0xff5bb045) : Colors.grey,
                  ),
                )),
            GestureDetector(
                onTap: () {
                ...
                child: Container(
                  ...
                  child: Icon(
                    ...
                    size: 30,
                    color:
                        indexColor == 1 ? const Color(0xff5bb045) : Colors.grey,
                  ),
                )),
            const SizedBox(
              width: 20,
            ...
            GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(
                    ...
                    size: 30,
                    color:
                        indexColor == 2 ? const Color(0xff5bb045) : Colors.grey,
                  ),
                )),
            GestureDetector(
                onTap: () {
                ...
                child: Container(
                  ...
                  child: Icon(
                    ...
                    size: 30,
                    color:
                        indexColor == 3 ? const Color(0xff5bb045) : Colors.grey,
                  ),
                )),
          ]),
        ),
